    ...
    <div>
      <nav className={`fixed top-0 w-full z-50 transition-all duration-500 ease-linear transform ${isScrolled ? 'bg-white dark:bg-gray-900 shadow-lg' : 'bg-transparent'}`}>
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between lg:justify-center xl:justify-between mx-auto lg:px-24 px-4 py-1">
          ...
          <div className="hidden w-full lg:block lg:w-auto font-gilda text-sm">
            <ul className={`flex flex-col xl:h-20 p-4 lg:p-0 mt-4 border rounded-lg lg:flex-row items-center ${isScrolled ? 'text-black' : 'text-white'} lg:space-x-8 rtl:space-x-reverse lg:mt-0 lg:border-0 dark:bg-gray-800 lg:dark:bg-gray-900 dark:border-gray-700`}>
              <li>
      ...
      <div
        ...
        <ul className="p-4 pr-10 mt-24 space-y-4">
          ...
          <li>
            <Link to="/location" className="block py-2 px-3 rounded lg:hover:bg-transparent lg:border-0 hover:text-coklat lg:p-0 dark:text-white lg:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white lg:dark:hover:bg-transparent">Location</Link>
          </li>
          <li>
